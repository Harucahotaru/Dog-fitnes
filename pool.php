...
<main class="container my-5">
    ...
    <section class="row m-0 mb-5 card-custom2 rounded-lg p-3">
        <div class="col-12">
            <h2 class="text-center">Преимущества плавания</h2>
        </div>
        <div class="row p-0 row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-3 position-relative">
            ...
            <div class="col">
                <div class="card h-100 rounded-lg">
                    <div class="card-body">
                        <p class="card-text">Дог фитнес вырабатывает у собаки выносливость</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 rounded-lg">
                    <div class="card-body">
                        <p class="card-text">Укрепляет дыхательную, сердечно-сосудистую, мышечную и нервную систему</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 rounded-lg">
                    <div class="card-body">
                        <p class="card-text">Снижает уровень гормона стресса, укрепляет слабые связки, распущенные
                            пясти, размет</p>
                    </div>
                </div>
            </div>
    ...
    <section class="position-relative">
        <div class="block-goo-section">
            <div class="goo-block card-custom1 rounded-lg p-3 mb-5 d-flex flex-column justify-content-center"
                ...
                <p>Так же щенок получает новые тактильные ощущения и минимальный массажный эффект. Он привыкает к новой среде и
